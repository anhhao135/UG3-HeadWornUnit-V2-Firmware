...
HD_PWD='C:/UG3-HeadWornUnit-V2-Firmware/seeg_tb/seeg_tb.runs/rhd_rhs_tb_seeg_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rhd_rhs_tb_seeg_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rhd_rhs_tb_seeg_0_0.tcl
