...
HD_PWD='C:/UG3-HeadWornUnit-V2-Firmware/seeg_tb/seeg_tb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rhd_rhs_tb_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rhd_rhs_tb_wrapper.tcl -notrace
