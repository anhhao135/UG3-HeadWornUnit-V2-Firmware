...
simulate()
{
  xsim rhd_rhs_tb -key {Behavioral:sim_1:Functional:rhd_rhs_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/xpm_cdc_1bit.protoinst" -protoinst "protoinst_files/rhd_rhs_tb.protoinst" -log simulate.log
}
