...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_infrastructure_v1_1_0 -L xil_defaultlib -L axi_vip_v1_1_14 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rhd_rhs_tb xil_defaultlib.rhd_rhs_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rhd_rhs_tb -key {Behavioral:sim_2_zcheck:Functional:rhd_rhs_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/xpm_cdc_1bit.protoinst" -protoinst "protoinst_files/rhd_rhs_tb.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rhd_rhs_tb.wdb xsim.dir libdpi.so)
