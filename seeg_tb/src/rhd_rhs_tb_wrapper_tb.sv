...
#1; 
  ...
  */
  ...
  // (2) Set packet length
  mtestWDataL = 32'h00000003; //binary is 1000, decimal is 8, batch size is 8
  ...
  // (2) Set packet length
  mtestWDataL = 32'h00000003; //packet length of 255, 8 Bytes for magic number + 4 Bytes/Channel * 32 Channels = 136 Bytes, total number 136 Bytes * [BATCH_SIZE] 
...
*/
  ...
  // (1b) Magnitude set
  mtestWDataL = 32'h0000025; //hex 5 turns off loopback, hex 25 turns ons
  mst_agent_rhs.AXI4LITE_WRITE_BURST(32'h0, mtestProtectionType, mtestWDataL, mtestBresp);
  mst_agent_rhs.AXI4LITE_READ_BURST(32'h0, mtestProtectionType, mtestRDataL, mtestBresp);
  #500us;
  mtestWDataL = 32'h00000000;
