...
module rhd_rhs_tb_wrapper_tb_zcheck();
...
#1; 
  ...
  */
  ...
  // (3) Impedance measurement cycle and scale
  mtestWDataL = 32'h00000300; //bin 11 00001000 scale of 3 and cycle of 2
  mst_agent_rhd.AXI4LITE_WRITE_BURST(32'hC, mtestProtectionType, mtestWDataL, mtestBresp);
  #1us;
  ...
  mtestWDataL = 32'h00000300; //binary 11 00000100, 3 SCALE, 2 CYCLE
...
*/
  ...
  // (1c) enable zcheck
  mtestWDataL = 32'b110001; //hex 9 turns loopback off, hex 29 turns on
  mst_agent_rhs.AXI4LITE_WRITE_BURST(32'h0, mtestProtectionType, mtestWDataL, mtestBresp);

  //RHD

  // (6) Impedance measurement start
  mtestWDataL = 32'h0000001D; // b11101, high sample mode on, zcheck mode on, high sample mode is 20ksps
