...
synth_design -top rhd_axi_tb_rhd_headstage_slave_0_6 -part xck26-sfvc784-2LVI-i -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix rhd_axi_tb_rhd_headstage_slave_0_6_ rhd_axi_tb_rhd_headstage_slave_0_6.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ rhd_axi_tb_rhd_headstage_slave_0_6_stub.v
 lappend ipCachedFiles rhd_axi_tb_rhd_headstage_slave_0_6_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ rhd_axi_tb_rhd_headstage_slave_0_6_stub.vhdl
 lappend ipCachedFiles rhd_axi_tb_rhd_headstage_slave_0_6_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ rhd_axi_tb_rhd_headstage_slave_0_6_sim_netlist.v
 lappend ipCachedFiles rhd_axi_tb_rhd_headstage_slave_0_6_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ rhd_axi_tb_rhd_headstage_slave_0_6_sim_netlist.vhdl
 lappend ipCachedFiles rhd_axi_tb_rhd_headstage_slave_0_6_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp rhd_axi_tb_rhd_headstage_slave_0_6.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips rhd_axi_tb_rhd_headstage_slave_0_6]
 }
...
rename_ref -prefix_all rhd_axi_tb_rhd_headstage_slave_0_6_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef rhd_axi_tb_rhd_headstage_slave_0_6.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "rhd_axi_tb_rhd_headstage_slave_0_6_synth_1_synth_report_utilization_0" "report_utilization -file rhd_axi_tb_rhd_headstage_slave_0_6_utilization_synth.rpt -pb rhd_axi_tb_rhd_headstage_slave_0_6_utilization_synth.pb"
...
OPTRACE "rhd_axi_tb_rhd_headstage_slave_0_6_synth_1" END { }
