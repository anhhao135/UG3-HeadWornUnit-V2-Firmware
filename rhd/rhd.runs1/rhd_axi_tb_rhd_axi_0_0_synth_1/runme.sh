...
HD_PWD='C:/Users/anhha/Desktop/UG3-HeadWornUnit-V2-Firmware/rhd/rhd.runs/rhd_axi_tb_rhd_axi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rhd_axi_tb_rhd_axi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rhd_axi_tb_rhd_axi_0_0.tcl
