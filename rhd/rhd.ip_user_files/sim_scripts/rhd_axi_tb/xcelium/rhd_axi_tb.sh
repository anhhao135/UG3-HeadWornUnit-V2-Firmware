...
#
# Script generated by Vivado on Thu Dec 07 11:04:42 -0800 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : rhd_axi_tb.sh
...
#
# Usage        : rhd_axi_tb.sh
#                rhd_axi_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rhd_axi_tb.sh [-reset_run]
#                rhd_axi_tb.sh [-reset_log]
#                rhd_axi_tb.sh [-help]
#
...
#                script (type 'rhd_axi_tb.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_14)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "rhd_axi_tb.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rhd_axi_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../bd/rhd_axi_tb/ip/rhd_axi_tb_rhd_axi_0_0/sim/rhd_axi_tb_rhd_axi_0_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"$ref_dir/../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"$ref_dir/../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../bd/rhd_axi_tb/ip/rhd_axi_tb_axi_vip_0_0/sim/rhd_axi_tb_axi_vip_0_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_14 $xmvlog_opts -sv +incdir+"$ref_dir/../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.rhd_axi_tb xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.rhd_axi_tb -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log rhd_axi_tb_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rhd_axi_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rhd_axi_tb.sh [-help]\n\
Usage: rhd_axi_tb.sh [-step]\n\
Usage: rhd_axi_tb.sh [-lib_map_path]\n\
Usage: rhd_axi_tb.sh [-reset_run]\n\
Usage: rhd_axi_tb.sh [-reset_log]\n\
Usage: rhd_axi_tb.sh [-keep_index]\n\
Usage: rhd_axi_tb.sh [-noclean_files]\n\n\
