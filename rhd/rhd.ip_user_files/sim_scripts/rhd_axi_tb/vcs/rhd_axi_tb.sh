...
design_libs=(xilinx_vip xpm xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_14)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../bd/rhd_axi_tb/ip/rhd_axi_tb_rhd_axi_0_0/sim/rhd_axi_tb_rhd_axi_0_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../bd/rhd_axi_tb/ip/rhd_axi_tb_axi_vip_0_0/sim/rhd_axi_tb_axi_vip_0_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_14 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"../../../../rhd.gen/sources_1/bd/rhd_axi_tb/ipshared/ec67/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rhd_axi_tb xil_defaultlib.glbl -o rhd_axi_tb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rhd_axi_tb_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key rhd_axi_tb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc rhd_axi_tb_simv.daidir vcs_lib c.obj)
