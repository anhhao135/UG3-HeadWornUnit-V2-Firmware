proc getPresetInfo {} {
  return [dict create name {headworn-v2-12-19-23} description {headworn-v2-12-19-23}  vlnv xilinx.com:ip:zynq_ultra_ps_e:3.5 display_name {headworn-v2-12-19-23} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PSU__PCIE__REF_CLK_SEL {Ref Clk1}  \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#SPI 1#GPIO0 MIO#GPIO0 MIO#SPI 1#SPI 1#SPI 1#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#I2C 1#I2C 1#UART 0#UART 0###PCIE#PMU GPI 5####PMU GPO 3#UART 1#UART 1##SD 1#SD 1#SD 1#SD 1#SD 1#USB0 Reset#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1##}  \
    ...
    CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {4.999950}  \
