...
HD_PWD='/home/ug3linux/UG3-HeadWornUnit-V2-Firmware/seeg/seeg.runs/main_smartconnect_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_smartconnect_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_smartconnect_0_0.tcl
