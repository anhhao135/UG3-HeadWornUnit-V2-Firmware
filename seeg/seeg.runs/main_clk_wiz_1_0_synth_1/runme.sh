...
HD_PWD='/media/ug3linux/UG3/firmware/UG3-HeadWornUnit-V2-Firmware/seeg/seeg.runs/main_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_clk_wiz_1_0.tcl
