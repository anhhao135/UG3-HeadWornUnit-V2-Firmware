...
#
# Script generated by Vivado on Mon Dec 18 12:12:58 -0800 2023
...
simulate()
{
  xsim fifo_generator_0 -key {Behavioral:sim_1:Functional:fifo_generator_0} -tclbatch cmd.tcl -protoinst "protoinst_files/xpm_cdc_1bit.protoinst" -log simulate.log
}
