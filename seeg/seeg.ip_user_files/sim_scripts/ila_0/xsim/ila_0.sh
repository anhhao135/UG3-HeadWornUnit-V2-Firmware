...
simulate()
{
  xsim ila_0 -key {Behavioral:sim_1:Functional:ila_0} -tclbatch cmd.tcl -protoinst "protoinst_files/xpm_cdc_1bit.protoinst" -protoinst "protoinst_files/bd_7793.protoinst" -protoinst "protoinst_files/bd_b752.protoinst" -protoinst "protoinst_files/bd_b612.protoinst" -log simulate.log
}
