...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../seeg.gen/sources_1/ip/ila_0/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../seeg.gen/sources_1/ip/ila_0/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../seeg.gen/sources_1/ip/ila_0/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
