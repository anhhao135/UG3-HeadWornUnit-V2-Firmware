...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_14 -L smartconnect_v1_0 -L zynq_ultra_ps_e_vip_v1_0_14 -L xilinx_vip"
...
simulate()
{
  xsim axis_data_fifo_0 -key {Behavioral:sim_1:Functional:axis_data_fifo_0} -tclbatch cmd.tcl -protoinst "protoinst_files/xpm_cdc_1bit.protoinst" -protoinst "protoinst_files/bd_7793.protoinst" -protoinst "protoinst_files/bd_b752.protoinst" -protoinst "protoinst_files/bd_b612.protoinst" -log simulate.log
}
