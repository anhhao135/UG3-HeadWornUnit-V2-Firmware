...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm_cdc_gen_v1_0_2 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xpm_cdc_1bit xil_defaultlib.xpm_cdc_1bit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xpm_cdc_1bit -key {Behavioral:sim_1:Functional:xpm_cdc_1bit} -tclbatch cmd.tcl -protoinst "protoinst_files/xpm_cdc_1bit.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xpm_cdc_1bit.wdb xsim.dir libdpi.so)
