...
design_libs=(xilinx_vip xpm xpm_cdc_gen_v1_0_2 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work xpm_cdc_gen_v1_0_2 $vlogan_opts +v2k +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.xpm_cdc_1bit xil_defaultlib.glbl -o xpm_cdc_1bit_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./xpm_cdc_1bit_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key xpm_cdc_1bit_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc xpm_cdc_1bit_simv.daidir vcs_lib c.obj)
