...
#
# Script generated by Vivado on Mon Dec 18 12:12:45 -0800 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : xpm_cdc_1bit.sh
...
#
# Usage        : xpm_cdc_1bit.sh
#                xpm_cdc_1bit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xpm_cdc_1bit.sh [-reset_run]
#                xpm_cdc_1bit.sh [-reset_log]
#                xpm_cdc_1bit.sh [-help]
#
...
#                script (type 'xpm_cdc_1bit.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xpm_cdc_gen_v1_0_2 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xpm_cdc_gen_v1_0_2 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "xpm_cdc_1bit.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xpm_cdc_1bit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work xpm_cdc_gen_v1_0_2 $xmvlog_opts +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.xpm_cdc_1bit xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.xpm_cdc_1bit -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log xpm_cdc_1bit_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./xpm_cdc_1bit.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: xpm_cdc_1bit.sh [-help]\n\
Usage: xpm_cdc_1bit.sh [-step]\n\
Usage: xpm_cdc_1bit.sh [-lib_map_path]\n\
Usage: xpm_cdc_1bit.sh [-reset_run]\n\
Usage: xpm_cdc_1bit.sh [-reset_log]\n\
Usage: xpm_cdc_1bit.sh [-keep_index]\n\
Usage: xpm_cdc_1bit.sh [-noclean_files]\n\n\
