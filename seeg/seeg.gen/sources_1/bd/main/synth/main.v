...
(* CORE_GENERATION_INFO = "main,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=main,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=12,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "main.hwdef" *) 
module main
   (RHD_CS,
    RHD_MISO1_A,
    RHD_MISO1_B,
  ...
  wire [4:0]master_smartconnect_1_M00_AXI_ARADDR;
  wire [2:0]master_smartconnect_1_M00_AXI_ARPROT;
  wire master_smartconnect_1_M00_AXI_ARREADY;
  wire master_smartconnect_1_M00_AXI_ARVALID;
  wire [4:0]master_smartconnect_1_M00_AXI_AWADDR;
  wire [2:0]master_smartconnect_1_M00_AXI_AWPROT;
  wire master_smartconnect_1_M00_AXI_AWREADY;
  wire master_smartconnect_1_M00_AXI_AWVALID;
  wire master_smartconnect_1_M00_AXI_BREADY;
  wire [1:0]master_smartconnect_1_M00_AXI_BRESP;
  wire master_smartconnect_1_M00_AXI_BVALID;
  wire [31:0]master_smartconnect_1_M00_AXI_RDATA;
  wire master_smartconnect_1_M00_AXI_RREADY;
  wire [1:0]master_smartconnect_1_M00_AXI_RRESP;
  wire master_smartconnect_1_M00_AXI_RVALID;
  wire [31:0]master_smartconnect_1_M00_AXI_WDATA;
  wire master_smartconnect_1_M00_AXI_WREADY;
  wire [3:0]master_smartconnect_1_M00_AXI_WSTRB;
  wire master_smartconnect_1_M00_AXI_WVALID;
  ...
  wire seeg_0_RHD_CS;
  wire seeg_0_RHD_MOSI;
  wire seeg_0_RHD_SCLK;
  wire seeg_0_RHS_CS;
  wire seeg_0_RHS_MOSI_A;
  wire seeg_0_RHS_MOSI_B;
  wire seeg_0_RHS_MOSI_C;
  wire seeg_0_RHS_MOSI_D;
  wire seeg_0_RHS_MOSI_E;
  wire seeg_0_RHS_MOSI_F;
  wire seeg_0_RHS_MOSI_G;
  wire seeg_0_RHS_MOSI_H;
  wire seeg_0_RHS_MOSI_I_N;
  wire seeg_0_RHS_MOSI_I_P;
  wire seeg_0_RHS_MOSI_J_N;
  wire seeg_0_RHS_MOSI_J_P;
  wire seeg_0_RHS_MOSI_K_N;
  wire seeg_0_RHS_MOSI_K_P;
  wire seeg_0_RHS_MOSI_L_N;
  wire seeg_0_RHS_MOSI_L_P;
  wire seeg_0_RHS_MOSI_M_N;
  wire seeg_0_RHS_MOSI_M_P;
  wire seeg_0_RHS_MOSI_N_N;
  wire seeg_0_RHS_MOSI_N_P;
  wire seeg_0_RHS_MOSI_O_N;
  wire seeg_0_RHS_MOSI_O_P;
  wire seeg_0_RHS_MOSI_P_N;
  wire seeg_0_RHS_MOSI_P_P;
  wire seeg_0_RHS_SCLK;
  ...
  assign RHD_MOSI = seeg_0_RHD_MOSI;
  assign RHD_SCLK = seeg_0_RHD_SCLK;
  assign RHS_CS = seeg_0_RHS_CS;
  ...
  assign RHS_MOSI_A = seeg_0_RHS_MOSI_A;
  assign RHS_MOSI_B = seeg_0_RHS_MOSI_B;
  assign RHS_MOSI_C = seeg_0_RHS_MOSI_C;
  assign RHS_MOSI_D = seeg_0_RHS_MOSI_D;
  assign RHS_MOSI_E = seeg_0_RHS_MOSI_E;
  assign RHS_MOSI_F = seeg_0_RHS_MOSI_F;
  assign RHS_MOSI_G = seeg_0_RHS_MOSI_G;
  assign RHS_MOSI_H = seeg_0_RHS_MOSI_H;
  assign RHS_MOSI_I_N = seeg_0_RHS_MOSI_I_N;
  assign RHS_MOSI_I_P = seeg_0_RHS_MOSI_I_P;
  assign RHS_MOSI_J_N = seeg_0_RHS_MOSI_J_N;
  assign RHS_MOSI_J_P = seeg_0_RHS_MOSI_J_P;
  assign RHS_MOSI_K_N = seeg_0_RHS_MOSI_K_N;
  assign RHS_MOSI_K_P = seeg_0_RHS_MOSI_K_P;
  assign RHS_MOSI_L_N = seeg_0_RHS_MOSI_L_N;
  assign RHS_MOSI_L_P = seeg_0_RHS_MOSI_L_P;
  assign RHS_MOSI_M_N = seeg_0_RHS_MOSI_M_N;
  assign RHS_MOSI_M_P = seeg_0_RHS_MOSI_M_P;
  assign RHS_MOSI_N_N = seeg_0_RHS_MOSI_N_N;
  assign RHS_MOSI_N_P = seeg_0_RHS_MOSI_N_P;
  assign RHS_MOSI_O_N = seeg_0_RHS_MOSI_O_N;
  assign RHS_MOSI_O_P = seeg_0_RHS_MOSI_O_P;
  assign RHS_MOSI_P_N = seeg_0_RHS_MOSI_P_N;
  assign RHS_MOSI_P_P = seeg_0_RHS_MOSI_P_P;
  assign RHS_SCLK = seeg_0_RHS_SCLK;
  main_axi_dma_0_0 axi_dma_0
       (.axi_resetn(proc_sys_reset_250M_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(seeg_0_M_AXIS_TDATA),
        .s_axis_s2mm_tkeep({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .s_axis_s2mm_tlast(seeg_0_M_AXIS_TLAST),
        .s_axis_s2mm_tready(seeg_0_M_AXIS_TREADY),
        .s_axis_s2mm_tvalid(seeg_0_M_AXIS_TVALID));
  ...
  main_smartconnect_0_1 master_smartconnect_1
       (.M00_AXI_araddr(master_smartconnect_1_M00_AXI_ARADDR),
        .M00_AXI_arprot(master_smartconnect_1_M00_AXI_ARPROT),
        .M00_AXI_arready(master_smartconnect_1_M00_AXI_ARREADY),
        .M00_AXI_arvalid(master_smartconnect_1_M00_AXI_ARVALID),
        .M00_AXI_awaddr(master_smartconnect_1_M00_AXI_AWADDR),
        .M00_AXI_awprot(master_smartconnect_1_M00_AXI_AWPROT),
        .M00_AXI_awready(master_smartconnect_1_M00_AXI_AWREADY),
        .M00_AXI_awvalid(master_smartconnect_1_M00_AXI_AWVALID),
        .M00_AXI_bready(master_smartconnect_1_M00_AXI_BREADY),
        .M00_AXI_bresp(master_smartconnect_1_M00_AXI_BRESP),
        .M00_AXI_bvalid(master_smartconnect_1_M00_AXI_BVALID),
        .M00_AXI_rdata(master_smartconnect_1_M00_AXI_RDATA),
        .M00_AXI_rready(master_smartconnect_1_M00_AXI_RREADY),
        .M00_AXI_rresp(master_smartconnect_1_M00_AXI_RRESP),
        .M00_AXI_rvalid(master_smartconnect_1_M00_AXI_RVALID),
        .M00_AXI_wdata(master_smartconnect_1_M00_AXI_WDATA),
        .M00_AXI_wready(master_smartconnect_1_M00_AXI_WREADY),
        .M00_AXI_wstrb(master_smartconnect_1_M00_AXI_WSTRB),
        .M00_AXI_wvalid(master_smartconnect_1_M00_AXI_WVALID),
  ...
  main_seeg_0_0 seeg_0
       (.M_AXIS_ACLK(Net),
        .M_AXIS_ARESETN(proc_sys_reset_250M_peripheral_aresetn),
        ...
        .RHD_MOSI(seeg_0_RHD_MOSI),
        .RHD_SCLK(seeg_0_RHD_SCLK),
        .RHS_CS(seeg_0_RHS_CS),
        ...
        .RHS_MOSI_A(seeg_0_RHS_MOSI_A),
        .RHS_MOSI_B(seeg_0_RHS_MOSI_B),
        .RHS_MOSI_C(seeg_0_RHS_MOSI_C),
        .RHS_MOSI_D(seeg_0_RHS_MOSI_D),
        .RHS_MOSI_E(seeg_0_RHS_MOSI_E),
        .RHS_MOSI_F(seeg_0_RHS_MOSI_F),
        .RHS_MOSI_G(seeg_0_RHS_MOSI_G),
        .RHS_MOSI_H(seeg_0_RHS_MOSI_H),
        .RHS_MOSI_I_N(seeg_0_RHS_MOSI_I_N),
        .RHS_MOSI_I_P(seeg_0_RHS_MOSI_I_P),
        .RHS_MOSI_J_N(seeg_0_RHS_MOSI_J_N),
        .RHS_MOSI_J_P(seeg_0_RHS_MOSI_J_P),
        .RHS_MOSI_K_N(seeg_0_RHS_MOSI_K_N),
        .RHS_MOSI_K_P(seeg_0_RHS_MOSI_K_P),
        .RHS_MOSI_L_N(seeg_0_RHS_MOSI_L_N),
        .RHS_MOSI_L_P(seeg_0_RHS_MOSI_L_P),
        .RHS_MOSI_M_N(seeg_0_RHS_MOSI_M_N),
        .RHS_MOSI_M_P(seeg_0_RHS_MOSI_M_P),
        .RHS_MOSI_N_N(seeg_0_RHS_MOSI_N_N),
        .RHS_MOSI_N_P(seeg_0_RHS_MOSI_N_P),
        .RHS_MOSI_O_N(seeg_0_RHS_MOSI_O_N),
        .RHS_MOSI_O_P(seeg_0_RHS_MOSI_O_P),
        .RHS_MOSI_P_N(seeg_0_RHS_MOSI_P_N),
        .RHS_MOSI_P_P(seeg_0_RHS_MOSI_P_P),
        .RHS_SCLK(seeg_0_RHS_SCLK),
        .s00_axi_rhd_aclk(clk_wiz_0_clk_rhd),
        .s00_axi_rhd_araddr(master_smartconnect_1_M00_AXI_ARADDR),
        .s00_axi_rhd_aresetn(proc_sys_reset_rhd_peripheral_aresetn),
        .s00_axi_rhd_arprot(master_smartconnect_1_M00_AXI_ARPROT),
        .s00_axi_rhd_arready(master_smartconnect_1_M00_AXI_ARREADY),
        .s00_axi_rhd_arvalid(master_smartconnect_1_M00_AXI_ARVALID),
        .s00_axi_rhd_awaddr(master_smartconnect_1_M00_AXI_AWADDR),
        .s00_axi_rhd_awprot(master_smartconnect_1_M00_AXI_AWPROT),
        .s00_axi_rhd_awready(master_smartconnect_1_M00_AXI_AWREADY),
        .s00_axi_rhd_awvalid(master_smartconnect_1_M00_AXI_AWVALID),
        .s00_axi_rhd_bready(master_smartconnect_1_M00_AXI_BREADY),
        .s00_axi_rhd_bresp(master_smartconnect_1_M00_AXI_BRESP),
        .s00_axi_rhd_bvalid(master_smartconnect_1_M00_AXI_BVALID),
        .s00_axi_rhd_rdata(master_smartconnect_1_M00_AXI_RDATA),
        .s00_axi_rhd_rready(master_smartconnect_1_M00_AXI_RREADY),
        .s00_axi_rhd_rresp(master_smartconnect_1_M00_AXI_RRESP),
        .s00_axi_rhd_rvalid(master_smartconnect_1_M00_AXI_RVALID),
        .s00_axi_rhd_wdata(master_smartconnect_1_M00_AXI_WDATA),
        .s00_axi_rhd_wready(master_smartconnect_1_M00_AXI_WREADY),
        .s00_axi_rhd_wstrb(master_smartconnect_1_M00_AXI_WSTRB),
        .s00_axi_rhd_wvalid(master_smartconnect_1_M00_AXI_WVALID),
        .s00_axi_rhs_aclk(clk_wiz_0_clk_rhs),
        .s00_axi_rhs_araddr(master_smartconnect_1_M01_AXI_ARADDR),
        .s00_axi_rhs_aresetn(proc_sys_reset_rhs_peripheral_aresetn),
        .s00_axi_rhs_arprot(master_smartconnect_1_M01_AXI_ARPROT),
        .s00_axi_rhs_arready(master_smartconnect_1_M01_AXI_ARREADY),
        .s00_axi_rhs_arvalid(master_smartconnect_1_M01_AXI_ARVALID),
        .s00_axi_rhs_awaddr(master_smartconnect_1_M01_AXI_AWADDR),
        .s00_axi_rhs_awprot(master_smartconnect_1_M01_AXI_AWPROT),
        .s00_axi_rhs_awready(master_smartconnect_1_M01_AXI_AWREADY),
        .s00_axi_rhs_awvalid(master_smartconnect_1_M01_AXI_AWVALID),
        .s00_axi_rhs_bready(master_smartconnect_1_M01_AXI_BREADY),
        .s00_axi_rhs_bresp(master_smartconnect_1_M01_AXI_BRESP),
        .s00_axi_rhs_bvalid(master_smartconnect_1_M01_AXI_BVALID),
        .s00_axi_rhs_rdata(master_smartconnect_1_M01_AXI_RDATA),
        .s00_axi_rhs_rready(master_smartconnect_1_M01_AXI_RREADY),
        .s00_axi_rhs_rresp(master_smartconnect_1_M01_AXI_RRESP),
        .s00_axi_rhs_rvalid(master_smartconnect_1_M01_AXI_RVALID),
        .s00_axi_rhs_wdata(master_smartconnect_1_M01_AXI_WDATA),
        .s00_axi_rhs_wready(master_smartconnect_1_M01_AXI_WREADY),
        .s00_axi_rhs_wstrb(master_smartconnect_1_M01_AXI_WSTRB),
        .s00_axi_rhs_wvalid(master_smartconnect_1_M01_AXI_WVALID));
