...
--               /media/ug3linux/UG3/firmware/UG3-HeadWornUnit-V2-Firmware/seeg/seeg.gen/sources_1/bd/main/ip/main_clk_wiz_1_0/main_clk_wiz_1_0_sim_netlist.vhdl
...
entity main_clk_wiz_1_0_clk_wiz is
  port (
    clk_dma_250M : out STD_LOGIC;
    locked : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end main_clk_wiz_1_0_clk_wiz;

architecture STRUCTURE of main_clk_wiz_1_0_clk_wiz is
  signal clk_dma_250M_main_clk_wiz_1_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_dma_250M_main_clk_wiz_1_0,
      O => clk_dma_250M
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT0 => clk_dma_250M_main_clk_wiz_1_0,
...
begin
inst: entity work.main_clk_wiz_1_0_clk_wiz
     port map (
      clk_dma_250M => clk_dma_250M,
      clk_in1 => clk_in1,
      locked => locked
    );
end STRUCTURE;
